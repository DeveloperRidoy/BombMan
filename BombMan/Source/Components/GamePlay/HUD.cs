...
namespace BombMan.Source.Components.GamePlay
{
    public class HUD : BaseComponent
    {
        ...
        public override void Draw()
        {
            ...
            Resource.SpriteBatch.DrawString(Art.DefaultFont, "Lives:", livesTextPosition, Color.White, 0f, Vector2.Zero, textScale, SpriteEffects.None, 0f);
            ...
            Resource.SpriteBatch.DrawString(Art.DefaultFont, levelText, levelTextPosition, Color.White, 0f, Vector2.Zero, textScale, SpriteEffects.None, 0f);
            ...
            Resource.SpriteBatch.DrawString(Art.DefaultFont, scoreText, scoreTextPosition, Color.White, 0f, Vector2.Zero, textScale, SpriteEffects.None, 0f);
            ...
            Resource.SpriteBatch.DrawString(Art.DefaultFont, highScoreText, highScoreTextPosition, Color.White, 0f, Vector2.Zero, textScale, SpriteEffects.None, 0f);
        }
